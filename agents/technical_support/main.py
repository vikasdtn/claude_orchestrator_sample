"""FastAPI server for Technical Support Agent."""
...
agent: TechnicalSupportAgent | None = None
...
app = FastAPI(title="Technical Support Agent", version="1.0.0", lifespan=lifespan)
